...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[lbryschema_dot_proto_dot_certificate__pb2.DESCRIPTOR,])
...
_SIGNATURE.fields_by_name['signatureType'].enum_type = lbryschema_dot_proto_dot_certificate__pb2._KEYTYPE
